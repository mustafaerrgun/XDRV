...
void XDR_GPIO_Init(xdr_gpio *xdr_gpio)
{
    ...
    xdr_gpio->xdr_gpiox->MODER |=
        (xdr_gpio->xdr_gpio_pinMode << (2U * (uint32_t)xdr_gpio->xdr_gpio_pin));

    // Configure GPIO output type register
    xdr_gpio->xdr_gpiox->OTYPER &= ~(0x1U << ((uint32_t)xdr_gpio->xdr_gpio_pin));
    xdr_gpio->xdr_gpiox->OTYPER |=
        (xdr_gpio->xdr_gpio_pinOType << ((uint32_t)xdr_gpio->xdr_gpio_pin));
    ...
    xdr_gpio->xdr_gpiox->PUPDR |=
        ((uint32_t)xdr_gpio->xdr_gpio_pinPuPd << (2U * (uint32_t)xdr_gpio->xdr_gpio_pin));
}
...
static void XDR_GPIO_Clock_Enable(const xdr_gpio *xdr_gpio)
{
    ...
    {
    case XDR_GPIO_PORT_A:
        GPIOA_CLOCK_ENABLE();
        break;
    case XDR_GPIO_PORT_B:
        GPIOB_CLOCK_ENABLE();
        break;
    case XDR_GPIO_PORT_C:
        GPIOC_CLOCK_ENABLE();
        break;
    case XDR_GPIO_PORT_D:
        GPIOD_CLOCK_ENABLE();
        break;
    case XDR_GPIO_PORT_E:
        GPIOE_CLOCK_ENABLE();
        break;
    case XDR_GPIO_PORT_F:
        GPIOF_CLOCK_ENABLE();
        break;
    case XDR_GPIO_PORT_G:
        GPIOG_CLOCK_ENABLE();
        break;
    case XDR_GPIO_PORT_H:
        GPIOH_CLOCK_ENABLE();
        break;
    case XDR_GPIO_PORT_I:
        GPIOI_CLOCK_ENABLE();
        break;
    case XDR_GPIO_PORT_J:
        GPIOJ_CLOCK_ENABLE();
        break;
    case XDR_GPIO_PORT_K:
        GPIOK_CLOCK_ENABLE();
        break;
    default:
        break;
